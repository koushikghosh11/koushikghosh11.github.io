(function ($) {
  ...
  $.fn.isInViewport = function() {
    ...
    return (elementBottom+elementTop)/2 < viewportBottom && elementBottom > viewportTop;
  };

  // custom fadeInLeft animation
  $(".fadeInLeft").each((i,e) => {
    var duration = $(e).data('wow-duration') || '1s';
    var delay = $(e).data('wow-delay') || '0.2s';
    $(e).css({'opacity': '0', 'transform': 'translateX(-100px)', 'animation-duration': duration, 'animation-delay': delay});
  });
  ...
  function onePageNavigation() {
    ...
    $('.st-smooth-move').on('click', function () {
      ...
      if ($(thisAttr).length) {
        scrollbar.scrollIntoView($(thisAttr)[0]);
        // var scrollPoint = $(thisAttr).offset().top - 10;
        // console.log(scrollbar.offset);
        // scrollbar.scrollTo(0, scrollPoint+10, 800);
        // $('body,html').animate({
